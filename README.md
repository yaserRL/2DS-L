In this project, we tried to implement S. Pourmohammad Azizi research "2DS-L: A dynamical system decomposition of signal approach to learning with application in time series prediction"
